...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="mt-5">
                    <div class="card-header text-center fw-bold fs-4 mb-4">Tạo gói dịch vụ mới</div>
                    <div class="card-body fw-bold">
                        <form method="POST" action="{{ route('package.store') }}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input id="input-name" type="text" name="description"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input id="input-name" type="number" name="max_jobs"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input id="input-name" type="number" name="price" 
